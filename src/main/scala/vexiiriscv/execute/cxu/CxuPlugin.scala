...
/**
 * CXU (Composable Extension Unit) allows people to implement custom instruction hardware outside the CPU through a stream based interface.
 * This plugin implements a draft version of the CXU spec.
 */
